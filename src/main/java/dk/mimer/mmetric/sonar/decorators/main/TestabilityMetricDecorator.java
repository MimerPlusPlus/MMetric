...
public class TestabilityMetricDecorator extends AbstractCompositeWeightDecorator implements Decorator {

	public Metric getMetric() {
		return MaintainabilityMetrics.TESTABILITY;
	}
	...
	public List<Metric> getDecoratedMetrics() {
		return Arrays.asList(COMPLEXITY_WEIGHT,UNIT_SIZE,TEST_COVERAGE_WEIGHT);
	}
}
